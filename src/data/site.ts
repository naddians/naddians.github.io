...
/**
 * То же самое для карточки раздела на главной, но сдвиг там нужен другой.
 * Карточка — прямоугольник 5×4, и подпись раздела лежит в её левом нижнем углу.
 ...
 *
 * Числа те же, что в COVER_FOCUS: 50% — центр, 100% — низ кадра.
 * Раздела нет в списке = берётся центр.
