...
const SCRIPTS = 10 * 1024; // сейчас 0: на сайте нет ни одного скрипта
...
/**
 * На сайт не приезжает JS. Сейчас его ровно ноль — сайт собирается в чистые
 * страницы, и это главная причина, почему он открывается быстро. Чужой скрипт
